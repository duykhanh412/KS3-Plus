...
public class DigraphGenerator {
   ...
   /**
    ...
    //Construct a default digraph
    public static Digraph defaultDigraph(Setting setting) {
    	int V = setting.numNodes;
    	int E = (int)(V*setting.edgeCoefficient);
        double p = (double) E / (V*(V-1)/setting.pCoefficient); //Original pCoefficient: 2.0 
        return DigraphGenerator.simple(V, p);
    }
